...
test_env = KinovaReachEnv(render_mode="human")

# Load the pre-trained model
model = PPO.load("./models/model_12500000.zip")   #change to "kinova_obs_trainPPO20M.zip" to test model trained on 20M timesteps
